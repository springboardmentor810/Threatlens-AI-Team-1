...
CREATE TABLE IF NOT EXISTS users (
    ...
    -- Must stay in step with UserRole in backend/app/schemas/user_schema.py,
    -- the role sets in backend/app/alerts/router.py, and ROLES in
    -- frontend/src/constants/roles.ts.
    role VARCHAR(50) NOT NULL CHECK (
        role IN ('security_analyst', 'soc_team_member', 'administrator', 'researcher')
    ),
